...
/**
 * Created by OS1 on 21.03.2016.
 */
public class Favorites_Adapter extends RecyclerView.Adapter<Publication_ViewHolder> {
    ...
    // интерфейс для работы с Favorites_Activity
//    public interface OnAvatarLoadListener {
//        void onAvatarLoading(ImageView avatarImageView, int publicationId, int authorId);
//    }
    ...
    public interface OnFavoritesClickListener {
        // void onFavoritesClicked(String operationName, Publication_ListItems tapeListItems, int favoritesPublicationRowId, int publicationId);
        void onFavoritesClicked(Publication tapeListItems, int publicationId);
    }
    ...
    public interface OnLikedClickListener {
        // void onLikedClicked(String operationName, Publication_ListItems tapeListItems, int likesPublicationRowId, int publicationId);
        void onLikedClicked(String operationName, Publication tapeListItems, int publicationId);
    }
    ...
    public Favorites_Adapter(Context context, List<Publication> publications) {
    ...
    public Publication_ViewHolder onCreateViewHolder(final ViewGroup viewGroup, int position) {
        ...
        // если Favorites_Activity выполняет интерфейс
//        if (context instanceof OnAvatarLoadListener)
//            // получаем ссылку на Favorites_Activity
...
//            throw new ClassCastException(context.toString() + " must implement OnAvatarLoadListener");
    ...
    public void onBindViewHolder(final Publication_ViewHolder viewHolder, final int position) {
        ...
        // final String address    = publication.getPublicationAddress();      //

        // String authorPageCoverLink  = publication.getAuthorPageCoverLink(); //
        // String authorAvatarLink     = publication.getAuthorAvatarLink();    //
        // String authorName             = publication.getAuthorName();            //
        // String userAddress          = publication.getAuthorAddress();         //
        // String userDescription      = publication.getAuthorDescription();     //
        // String userSite             = publication.getAuthorSite();            //
...
//        intent.putExtra("streetName",       streetName);
        ...
        // avatarLoadListener.onAvatarLoading(viewHolder.userAvatar, publicationId, authorId);
        ...
        viewHolder.userAvatar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (intent != null)
                    //
                    ((Favorites_Activity) context).startActivityForResult(intent, USER_PROFILE_RESULT);
            }
        });
        ...
        viewHolder.badgeImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Log.d("Favorites_Adapter", "badge where date: " + viewHolder.publicationDate.getText().toString());
        ...
        viewHolder.textContainerLL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Log.d(LOG_TAG, "Favorites_Adapter:onBindViewHolder:itemId= " + publication.getPublicationId() + ", likedSum= " + publication.getLikedSum());
...
//                intent.putExtra("likedPublicationRowId", publication.getLikedPublicationRowId());
                ...
                ((Favorites_Activity) context).startActivityForResult(intent, 0);
                */

                ((Favorites_Activity) context).startActivityForResult(intent, ANSWERS_RESULT);
            }
        });
        ...
        ((Favorites_Activity) context).addImagesToPublication(viewHolder.photoContainerLL, publication.getMediaLinkList());
        ...
        ((Favorites_Activity) context).addQuizToPublication(viewHolder.quizContainerLL, publicationId, publication.getQuiz());
        ...
        viewHolder.favoritesWrapLL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                favoritesListener.onFavoritesClicked(publication, publicationId);
                ...
                if (publication.isPublicationFavorite()) {
                    ...
                    viewHolder.favorites.setImageResource(R.drawable.star_icon);
                }
                // если favorite надо добавить
                else {
                    favoritesListener.onFavoritesClicked("add", publication, 0, publicationId);
                    viewHolder.favorites.setImageResource(R.drawable.star_icon_active);
                }
                */
            }
        });
